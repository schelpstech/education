    ...
    <div id="js-grid-mosaic" class="cbp cbp-l-grid-mosaic">
        ...
        <div class="cbp-item">
            <div class="demo height2">
                <figure class="imghvr-blocks-rotate-right"><img class="img-responsive" src="education/img/portfolio1.png" alt="">
                    <figcaption>
        ...
        <div class="cbp-item">
            <div class="demo height2">
                <figure class="imghvr-blocks-rotate-right">  <img class="img-responsive" src="education/img/portfolio2.png" alt="">
        ...
        <div class="cbp-item">
            <div class="demo height1">
                <figure class="imghvr-blocks-rotate-right"><img class="img-responsive" src="education/img/portfolio4.png" alt="">
        ...
        <div class="cbp-item">
            <div class="demo">
                <figure class="imghvr-blocks-rotate-right"> <img class="img-responsive" src="education/img/portfolio5.png" alt="">
        ...
        <div class="cbp-item">
            <div class="demo">
                <figure class="imghvr-blocks-rotate-right"><img class="img-responsive" src="education/img/portfolio6.png" alt="">
        ...
        <div class="cbp-item">
            <div class="demo">
                <figure class="imghvr-blocks-rotate-right"> <img class="img-responsive" src="education/img/portfolio7.png" alt="">
                 ...
                 <div class="owl-carousel owl-theme no-gutters" id="blog-carousal">
                     ...
                     <div class="item blog-item">
                         ...
                         <div class="blog-text">
                             ...
                             <div class="info-blog mb-3">
                                 <a href="education/blog.html" class="text-decoration-none"><h4 class="blue-color mb-0 mt-1 hover-heading">Annual Festival</h4></a>
                             ...
                             <a href="education/blog.html" class="btn btn-primary rounded-pill navbar-btn mt-4 ml-1">Read More</a>
                         </div>
                     </div>
                     ...
                     <div class="item blog-item">
                         ...
                         <div class="blog-text">
                             ...
                             <div class="info-blog mb-3">
                                 <a href="education/blog.html" class="text-decoration-none"><h4 class="blue-color mb-0 mt-1 hover-heading">Graduation Day</h4></a>
                     ...
                     <div class="item blog-item">
                         ...
                         <div class="blog-text">
                             ...
                             <div class="info-blog mb-3">
                                 <a href="education/blog.html" class="text-decoration-none"><h4 class="blue-color mb-0 mt-1 hover-heading">Campus Life</h4></a>
